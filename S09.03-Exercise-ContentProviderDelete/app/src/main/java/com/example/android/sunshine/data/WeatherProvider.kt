...
class WeatherProvider : ContentProvider() {
            ...
            CODE_WEATHER -> {
                ...
                try {
                    for (value in values) {
                        ...
                        val _id = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,
                                null, value)
                        if (_id != -1L) {
                            rowsInserted++
                        }
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        ...
        when(sUriMatcher.match(uri)) {
            CODE_WEATHER -> {
                deleted = db!!.delete(WeatherContract.WeatherEntry.TABLE_NAME, null, null)
            }
